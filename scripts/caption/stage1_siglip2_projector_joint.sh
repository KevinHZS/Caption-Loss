...
LOG_DIR="${LOG_DIR:-$ROOT/output/stage1_siglip2_projector_joint_finehard_fixed}"
...
RUN_NAME="${RUN_NAME:-stage1_siglip2_projector_joint_bs3072_lr1e-6_proj1e-5_$(date +%Y%m%d_%H%M%S)}"
