...
LOG_DIR="${LOG_DIR:-$ROOT/output/stage2_fgclip2_bs160_epo10_2ji_so_zero1}"
...
ADD_BOX_LOSS="${ADD_BOX_LOSS:-True}"
USE_HARD_NEG="${USE_HARD_NEG:-True}"
PER_DEVICE_TRAIN_BATCH_SIZE="${PER_DEVICE_TRAIN_BATCH_SIZE:-160}"
...
deepspeed \
  ...
  fgclip2/train/train.py \
    --deepspeed "$ROOT/scripts/zero1.json" \
