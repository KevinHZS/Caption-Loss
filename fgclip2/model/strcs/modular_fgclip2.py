...
class Fgclip2TextConfig(Siglip2TextConfig):
    ...
    >>> # Initializing a Fgclip2TextConfig with qihoo/fg-clip2-base style configuration
    >>> configuration = Fgclip2TextConfig()

    >>> # Initializing a Fgclip2TextModel (with random weights) from the qihoo/fg-clip2-base style configuration
...
class Fgclip2VisionConfig(Siglip2VisionConfig):
    ...
    [qihoo/fg-clip2-base](https://huggingface.co/qihoo/fg-clip2-base) architecture.
    ...
    >>> # Initializing a Fgclip2VisionConfig with qihoo/fg-clip2-base style configuration
    >>> configuration = Fgclip2VisionConfig()

    >>> # Initializing a Fgclip2VisionModel (with random weights) from the qihoo/fg-clip2-base style configuration
...
class Fgclip2Config(Siglip2Config):
    ...
    >>> # Initializing a Fgclip2Config with qihoo/fg-clip2-base style configuration
    >>> configuration = Fgclip2Config()

    >>> # Initializing a Fgclip2Model (with random weights) from the qihoo/fg-clip2-base style configuration
