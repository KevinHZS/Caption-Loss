...
"""Fast Image processor class for FG-CLIP2."""
...
from .image_processing_fgclip2 import get_image_size_for_max_num_patches
...
class Fgclip2FastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    """
...
@auto_docstring
class Fgclip2ImageProcessorFast(BaseImageProcessorFast):
    ...
    valid_kwargs = Fgclip2FastImageProcessorKwargs
    unused_kwargs = ["size", "do_center_crop", "crop_size"]

    def __init__(self, **kwargs: Unpack[Fgclip2FastImageProcessorKwargs]):
    ...
    @auto_docstring
    def preprocess(self, images: ImageInput, **kwargs: Unpack[Fgclip2FastImageProcessorKwargs]) -> BatchFeature:
...
__all__ = ["Fgclip2ImageProcessorFast"]
